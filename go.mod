...
require (
	...
	github.com/knative/pkg v0.0.0-20181129214524-bace35862602 // indirect
	...
	github.com/shurcooL/githubv4 v0.0.0-20181111053151-5851091a7645 // indirect
